...
//admin services	
	public UserDetails validateAdmin(UserDetails admin) {
		...
		if (dbuser != null && dbuser.getPassword().equals(admin.getPassword())
...
//doctor services	
	public DoctorModel validateDoctor(UserDetails doctor) {
		...
		if (dbuser != null && dbuser.getPassword().equals(doctor.getPassword())
...
//supplier services
	public SupplierModel validateSupplier(UserDetails supplier) {
		...
		if (dbuser != null && dbuser.getPassword().equals(supplier.getPassword())
